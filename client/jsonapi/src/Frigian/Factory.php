...
namespace Aimeos\Client\JsonApi\Frigian;


/**
 * Factory for frigian JSON API client
 *
 * @package Client
 * @subpackage JsonApi
 */
...
{
	/**
	 * Creates a frigian client object.
	 *
	 * @param \Aimeos\MShop\Context\Item\Iface $context Shop context instance with necessary objects
	 * @param string $path Name of the client separated by slashes, e.g "frigian"
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $path, string $name = null ) : \Aimeos\Client\JsonApi\Iface
	{
		...
		if( $name === null ) {
			$name = $context->getConfig()->get( 'client/jsonapi/frigian/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\JsonApi\\Iface';
		$classname = '\\Aimeos\\Client\\JsonApi\\Frigian\\' . $name;
