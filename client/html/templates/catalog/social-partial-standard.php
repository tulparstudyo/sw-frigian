...
<div class="frigian-product-var__item">
		...
		<div class="vl"></div>
	<a href="#modalShippinginfo" style="margin-left:15px " data-toggle="modal"  class="actions-button "><i   style ="background: transparent;width: 40px; height:40px;line-height: 34px;"  data-toggle="tooltip" data-placement="top" title="<?= $enc->attr( $this->translate( 'client', 'Shipping' ) ); ?>"  class="fas fa-shipping-timed"></i></a>
	
	<a class="actions-button "><i style ="width: 40px; height:40px;background: transparent;line-height: 34px;" data-toggle="tooltip" data-placement="top" title="<?= $enc->attr( $this->translate( 'client', 'Safe Checkout' ) ); ?>" class="fas fa-user-shield"></i></i></a>
	
			<a id="social-share"> <i style="background: transparent;width: 40px; height:40px;line-height: 34px;" data-toggle="tooltip" data-placement="top" title="<?= $enc->attr( $this->translate( 'client', 'Share' ) ); ?>" class="fas fa-share-alt"></i> </a>
