...
?>
<div class="row form-item form-box__single-group salutation <?= $enc->attr( ( $this->value( 'error', 'order.base.address.salutation' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.salutation', [] ) ) ) ?>">
...
<div class="row">
<div class="col-lg-6">
<div class=" form-item form-box__single-group firstname <?= $enc->attr( ( $this->value( 'error', 'order.base.address.firstname' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.firstname', [] ) ) ) ?>"
...
<div class="col-lg-6">
<div class=" form-item form-box__single-group lastname <?= $enc->attr( ( $this->value( 'error', 'order.base.address.lastname' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.lastname', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group company <?= $enc->attr( ( $this->value( 'error', 'order.base.address.company' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.company', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group address1 <?= $enc->attr( ( $this->value( 'error', 'order.base.address.address1' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.address1', [] ) ) ) ?>"
...
<?php /*
<div class="row form-item form-box__single-group address2 <?= $enc->attr( ( $this->value( 'error', 'order.base.address.address2' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.address2', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group address3 <?= $enc->attr( ( $this->value( 'error', 'order.base.address.address3' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.address3', [] ) ) ) ?>"
...
<div class="row">
<div class="col-lg-6">
<div class="row form-item form-box__single-group city <?= $enc->attr( ( $this->value( 'error', 'order.base.address.city' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.city', [] ) ) ) ?>"
...
<div class="col-lg-6">
<div class="row form-item form-box__single-group postal <?= $enc->attr( ( $this->value( 'error', 'order.base.address.postal' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.postal', [] ) ) ) ?>"
...
<?php if( count( $this->get( 'states', [] ) ) > 0 ) : ?>
	<div class="row form-item form-box__single-group state <?= $enc->attr( ( $this->value( 'error', 'order.base.address.state' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.state', [] ) ) ) ?>">
...
<?php if( count( $this->get( 'countries', [] ) ) > 0 ) : ?>
	<div class="row form-item form-box__single-group countryid <?= $enc->attr( ( $this->value( 'error', 'order.base.address.countryid' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.countryid', [] ) ) ) ?>">
...
<?php if( count( $this->get( 'languages', [] ) ) > 0 ) : ?>
	<div class="row form-item form-box__single-group languageid <?= $enc->attr( ( $this->value( 'error', 'order.base.address.languageid' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.languageid', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group vatid <?= $enc->attr( ( $this->value( 'error', 'order.base.address.vatid' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.vatid', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group email <?= $enc->attr( ( $this->value( 'error', 'order.base.address.email' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.email', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group telephone <?= $enc->attr( ( $this->value( 'error', 'order.base.address.telephone' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.telephone', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group telefax <?= $enc->attr( ( $this->value( 'error', 'order.base.address.telefax' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.telefax', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group website <?= $enc->attr( ( $this->value( 'error', 'order.base.address.website' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.website', [] ) ) ) ?>"
...
<div class="row form-item form-box__single-group birthday <?= $enc->attr( ( $this->value( 'error', 'order.base.address.birthday' ) ? 'error ' : '' ) . join( ' ', $this->value( 'css', 'order.base.address.birthday', [] ) ) ) ?>">
