...
$this->pdf->setFooterFunction( function( $pdf ) {
	$pdf->writeHtmlCell( 180, 22.5, 15, -22.5, '
		<table cellpadding="0.5" style="font-size: 8px">
			<tr>
				<td style="font-weight: bold">EkolMarket</td>
				<td></td>
				<td></td>
			</tr>
			<tr>
				<td> Moscow region Domodedovsky district, village Starosyanovo st. New 11 </td>
			
			</tr>
			<tr>
				<td>Telephone: +7 (495) 542-40-60 </td>
				
			</tr>
			<tr>
				<td>E-Mail:  sales@ekolmarket.ru</td>
...
<?php $this->block()->start( 'email/payment/pdf' ); ?>
	...
	<h1 class="address-self">
		<span class="company">EkolMarket </span> · МО Домодедовский р-н д.Старосъяново ул. Новая 11
	</h1>
	<table>
		<tr>
