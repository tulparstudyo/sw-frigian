					...
					<div class="quantity">
						<?php if( $priceTaxflag === true ) : ?>
							<ul class="modal__product-shipping-info">
                                <li class="link--icon-left"><i class="icon-shopping-cart"></i> There Are&nbsp; <a href="/shop/basket"> <?= $enc->html( sprintf( $this->translate( 'client', '%1$d article', '%1$d articles', $totalQuantity ), $totalQuantity ) ); ?> </a> &nbsp; In Your Cart.</li>
                                <li>TOTAL PRICE: <span><?= $enc->html( sprintf( $priceFormat, $this->number( $this->summaryBasket->getPrice()->getValue() + $this->summaryBasket->getPrice()->getCosts(), $precision ), $priceCurrency ) ); ?></span></li>
                                <li><a href="<?= url('/shop/basket')?>" class=" text-underline color-green" data-dismiss="modal">Go To Basket</a></li>
                        	</ul>
