...
<div class="account-profile-address">
	<h4 class="account-title"><?= $enc->html( $this->translate( 'client', 'Address' ) ) ?></h4>
	...
	<form method="POST" action="<?= $enc->attr( $this->link( 'client/html/account/profile/url' ) ); ?>">
		...
		<div class="row">
			<div class="billing col-lg-6">
				<h6 class="header"><?= $enc->html( $this->translate( 'client', 'Billing address' ) ) ?></h6>
				...
				<div class="panel panel-default address-billing">
					<div class="panel-heading" role="button" data-toggle="collapse" href="#address-payment" aria-expanded="false" aria-controls="address-payment">
						...
						<i class="far fa-edit"></i>
						 <?= $enc->html( $this->translate( 'client', 'Edit Address' ), $enc::TRUST ); ?>
						</div> 
					</div>
					<div class="panel-body collapse" id="address-payment">
						...
						<div class="button-group">
							<button style="padding:10px 45px " class=" m-l-15 btn--radius-tiny btn--green btn--green-hover-black btn--uppercase btn--weight m-r-20" value="1" name="<?= $enc->attr( $this->formparam( array( 'address', 'save' ) ) ); ?>" >
			...
			<div class="delivery col-lg-6">
				...
				<?php foreach( $this->addressDelivery as $pos => $addr ) : ?>
					<div class="panel panel-default address-delivery">
						<div class="panel-heading" data-toggle="collapse" href="#address-delivery-<?= $enc->attr( $pos ) ?>" aria-expanded="false" aria-controls="address-delivery-<?= $enc->attr( $pos ) ?>">
							...
							<div style="display:block; margin:10px 0;cursor:pointer">
						...
						<div class="panel-body collapse" id="address-delivery-<?= $enc->attr( $pos ) ?>">
							...
							<div class="button-group">
								<button style="padding:10px 45px " class=" m-l-15 btn--radius-tiny btn--black btn--black-hover-green btn--uppercase btn--weight m-r-20" value="<?= $pos ?>" name="<?= $enc->attr( $this->formparam( array( 'address', 'delete' ) ) ); ?>" >
				...
				<div class="panel panel-default address-delivery-new">
					...
					<div class="panel-body collapse" id="address-delivery-<?= $enc->attr( $pos ) ?>">
						...
						<div class="button-group">
							<button style="padding:10px 45px " class=" m-l-15 btn--radius-tiny btn--black btn--black-hover-green btn--uppercase btn--weight m-r-20" value="1" type="reset" >
