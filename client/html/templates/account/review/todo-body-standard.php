...
<?php if( !$productItems->isEmpty() ) : ?>
	...
	<div class="account-review-todo">
		<form method="POST" action="<?= $enc->attr( $this->link( 'client/html/account/review/url' ) ) ?>">
			...
			<button class="btn btn--long btn--radius-tiny btn--green btn--green-hover-black btn--uppercase btn--weight m-r-20"><?= $enc->attr( $this->translate( 'client', 'Send Review' ) ) ?></button>
	...
	<p> <?= $this->translate('client','You can comment on the products you have ordered.'); ?></p>
	</div>
