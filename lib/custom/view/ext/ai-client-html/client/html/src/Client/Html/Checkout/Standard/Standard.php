	...
	implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartNames = array( 'delivery', 'address', 'payment', 'summary', 'process' );
	private $view;
	...
	public function getBody( string $uid = '' ) : string
	{
		...
		try
		{
			...
			$html = '';
            $subclients = [];
            foreach($this->getSubClients() as $key=>$subclient){

                if($key=='delivery'){
                    
                } elseif($key=='payment'){
                    $subclients['delivery'] = $this->getSubClients()['delivery'];
                    $subclients[$key] = $subclient;
