      ...
      <div id="header" class="row item-header tab-pane col-md-12" role="tabpanel" aria-labelledby="header">
        ...
        <div class="col-md-12 home-section">
          ...
          <div class="form-group row">
            ...
            <input type="radio" name="option[header_type]" value="standard" <?php if(isset($this->items['header_type'])) echo is_selected($this->items, 'header_type', 'standard')?>> Standard<img style="max-width:100%" src="<?=frigian_url('assets\img\header\header-standard.png')?>">
            </label>
            <label class="text-left">
            <input type="radio" name="option[header_type]" value="clear" <?php if(isset($this->items['header_type'])) echo is_selected($this->items, 'header_type', 'clear')?>> Clear<img style="max-width:100%" src="<?=frigian_url('assets\img\header\header-clear.png')?>">
            </label>
            </div>
          </div>
          <div class="form-group row ">
